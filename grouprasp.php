      ...
      <div class="container">
          ...
          {?>
           <div class="row align-items-center">
              <main class="col">
                  <div class="card">
                      <h5 class="card-header">Расписание группы <?php echo $_GET["name"];?></h5>
                  </div>
              </main>
          </div>  
...
if(isset($_GET['dept_id']))
{
    ...
    $api_address = "https://portal.kuzstu.ru/api/student_schedule?group_id=".$_GET['dept_id'];
   rasp($api_address);
}
   ?>
     </div> 
    ...
    for ($n = 0; $n < count($border_obj); $n++) 
    {
        if($border_obj[$n]["date_lesson"]>=date('Y-m-d'))
        {
            ...
            echo"
                          ...
                          <p class='card-text'>
                           <b>&#127970; Аудитория:</b> <a class='navbar-brand' href='aud_search.php?aud=".$border_obj[$n]["place"]."'>".$border_obj[$n]["place"]."</p>
