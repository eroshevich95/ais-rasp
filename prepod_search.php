...
if(isset($_GET['fio']))
{
    ...
    $api_address = "https://portal.kuzstu.ru/api/teachers?teacher=".$_GET['fio'];
   // rasp($api_address);
 ...
 <div class="card">
    ...
    { ?>
        <div class="mb-3">
        <a class="btn btn-dark" href="prepodrasp.php?id_prepod=<?php echo $border_obj[$n]["person_id"]."&fio=".$border_obj[$n]["name"];?>"><?php echo $border_obj[$n]["name"];?></a>
           </div>
   <?php }
}
